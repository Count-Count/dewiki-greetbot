...
pscp ../{greetbot.py,stats.py,Pipfile,Pipfile.lock} exec-bot.sh update-stats.sh greetbot-deployment.yaml countcount@login.tools.wmflabs.org:/data/project/dewikigreetbot/
